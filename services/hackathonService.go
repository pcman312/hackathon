...
// addOne is a function that we can unit test. This isn't a function that is used nor meaningful, but we just needed something that could easily be unit tested
